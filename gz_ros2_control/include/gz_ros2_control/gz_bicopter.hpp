...
#ifndef GZ_ROS2_CONTROL__GZ_BICOPTER_HPP_
#define GZ_ROS2_CONTROL__GZ_BICOPTER_HPP_
...
private:
  ...
  std::unique_ptr<GazeboSimBicopterPrivate> dataPtr;
};

}  // namespace gz_ros2_control

#endif  // GZ_ROS2_CONTROL__GZ_BICOPTER_HPP_
